      ...
      <div className="flex min-h-screen bg-gray-100 dark:bg-gray-900 text-foreground">
        ...
        <div className="flex-1 h-[calc(100vh-64px)] bg-gray-100 dark:bg-gray-900">
          ...
          <main className="flex flex-1 overflow-hidden" style={{ height: "calc(100vh - 64px)" }}>
            ...
            <div
              className="flex flex-col h-full border-r border-gray-200 dark:border-gray-700 animate-pulse"
              style={{ flex: "0 0 60%" }}
            >
                ...
                <Tabs defaultValue="transcript" className="flex flex-col h-full">
                  <TabsList className="w-full justify-start border-b mt-2 border-gray-200 dark:border-gray-700 rounded-none bg-white dark:bg-gray-800">
                    <Button
                      variant="outline"
                      disabled
                      className="h-10 w-24 bg-gray-300 dark:bg-gray-700 rounded"
                    >
                      <div className="w-4 h-4 bg-gray-400 dark:bg-gray-600 rounded" />
                    </Button>
                    <TabsTrigger value="transcript" className="h-10 w-24 bg-gray-300 dark:bg-gray-700 rounded" />
                    <TabsTrigger value="mynotes" className="h-10 w-24 bg-gray-300 dark:bg-gray-700 rounded" />
                    <Button
                      variant="outline"
                      disabled
                      className="h-10 w-24 bg-gray-300 dark:bg-gray-700 rounded"
            ...
            <div
              className="flex flex-col h-full overflow-hidden bg-white dark:bg-gray-800 animate-pulse"
              style={{ flex: "0 0 39.75%" }}
            >
              <Tabs defaultValue="notes" className="flex flex-col h-full">
                <TabsList className="w-full justify-start border-b border-gray-200 dark:border-gray-700 rounded-none bg-white dark:bg-gray-800">
                  <TabsTrigger value="notes" className="h-10 w-24 bg-gray-300 dark:bg-gray-700 rounded" />
                  <TabsTrigger value="chat" className="h-10 w-24 bg-gray-300 dark:bg-gray-700 rounded" />
                  <TabsTrigger value="quiz" className="h-10 w-24 bg-gray-300 dark:bg-gray-700 rounded" />
                </TabsList>
                <ScrollArea className="h-full">
                  <div className="p-3 space-y-2">
                    {Array(5).fill(null).map((_, index) => (
